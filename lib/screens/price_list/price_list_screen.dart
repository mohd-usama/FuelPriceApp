              ...
              children: [
                TextFormField(
                  ...
                  decoration: InputDecoration(
                      ...
                      label: Text("Search State"),
                      labelStyle: TextStyle(color: Colors.black),
                      fillColor: Colors.white,
                      filled: true,
                      focusedBorder:
                          OutlineInputBorder(borderRadius: BorderRadius.circular(7), borderSide: BorderSide(color: Colors.white)),
                      border:
                          OutlineInputBorder(borderRadius: BorderRadius.circular(7), borderSide: BorderSide(color: Colors.white))),
                ),
                Expanded(
                                  ...
                                  Row(
                                    children: [
                                      Expanded(
                                          child: Row(
                                        children: [
                                          Icon(Icons.pin_drop_rounded, size: 40, color: Colors.blue),
                                          Text(data.state!, style: TextStyle(fontSize: 20, fontWeight: FontWeight.w500))
                                        ],
                                      )),
